...
export default function AsideBar({openModal,openJoinModal}) {
    ...
    return (
        <div className={`aside-bar  lg:static  flex flex-col w-full lg:w-[30%] space-y-3 p-4 border-t lg:border-l lg:border-t-0 ${darkMode?"bg-[#212529]  border-white":"bg-white border-[#d3d3d3]"}`}>
