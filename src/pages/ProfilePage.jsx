...
export default function ProfilePage() {
    ...
    return (
        <div className="main-profile-div w-full flex flex-col lg:flex-row p-5">
            <div className="main-profile w-full lg:w-[50%] flex flex-col justify-center items-center p-5 h-[400px]">
